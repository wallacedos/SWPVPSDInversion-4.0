function [g,Hess,HessDiagElement] = calcRayleighDCInvGradHess(ObsInfo,ModelInfo,m0,fValue0,epsilon,mReference,misfitType, stateId)
%   Summary of this function goes here.
%   [g,Hess,HessDiagElement] = calcRayleighDCInvGradHess(ObsInfo,ModelInfo,m0,fValue0,epsilon,mReference,misfitType, stateId)
%   Detailed explanation goes here.
%   The function is for calculating the gradient and Hessian matrix of
%   the misfit function of rayleigh wave dispersion inversion.
...
%
%  OUT
%               g: the gradient of the misfit function at current model
%                  point m0.
%            Hess: the Hessian matrix of the misfit function at current model
%                  point m0,it is considered as a diagonally-dominant
%                  matrix, this parameter serves as a placeholder and is
%                  not output.
...
%          11/28/2022.
%          2£© Adding the fast computing method, the computational
...
if strcmp(stateId, "Common")
    parfor i=1:n
        ...
        pvPredicted = calcmulti(f,VSTemp,HTemp,VPTemp,den,maxModeSN);
...
if strcmp(stateId,"Fast")  && strcmp(misfitType,"L2")
    ...
    [JMatrix,JMatrix_trans] = calcJacobiMatrix(ObsInfo,ModelInfo,m0);
