function [JMatrix,JMatrix_trans] = calcJacobiMatrix(ObsInfo,ModelInfo,m0)
...
%   function of rayleigh wave dispersion inversion.
%
%
%   IN
...
paraNum = length(m0);
numLayer = floor((paraNum+1+0.1)/2);
...
for k=1:modeNum
    ...
    for i=Ind_k
        ...
        DValue0 = fastcalc(pvPred, freq,m);
    ...
    parfor iEle=1:elementNum
        ...
        j = jSequence(iEle);
        JMat(iEle,k)= calcJacobiMatrix_Ele(freq,pvPred,DValue0,m0,VP0,DEN0,j);
    end
end
for k=1:modeNum
    Ind_k = IndCell{k};
